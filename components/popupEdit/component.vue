        ...
        <div class="cover">
            <div class="box">
                ...
                <div class="form">
                    ...
                    <input :style="errorStatePassword ? `border-color:red;` : `border-color:#cccccc;margin: 20px auto;`" v-model="password" type="password" placeholder="password" @keyup.enter="editData" >
